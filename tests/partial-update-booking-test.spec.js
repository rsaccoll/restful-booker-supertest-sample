...
describe('PATCH - Partial Update a book tests', function() {
    ...
    it('PUT - PartialUpdateBooking - partial update a bookingID', async() => {
    ...
    it('PUT - PartialUpdateBooking - Partial Update a bookingID withou Auth', async() => {
